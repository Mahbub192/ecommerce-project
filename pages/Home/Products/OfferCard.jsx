  ...
  return (
    <div className="mx-auto container mt-10 flex flex-wrap gap-16 md:gap-0">
      <div className="w-full md:w-1/6 flex-row  ">
        <div className="bg-gray-300 px-5 pb-5">
        ...
        <div className="pt-24 relative">
          ...
          <Image className="bg-gray-200 py-5 rounded-lg" src={nothing} alt="" />
          <p className="my-5 text-black">Game Console Controner + USB 3.0 cable</p>
        ...
        <div className="bg-gray-300 mt-2 py-5 px-5">
          <p className="text-center text-lg font-bold py-5">Hurry Up! Offer Ends In :</p>
        ...
        {/* Recommended For You */}
        <div className="mt-3 py-5 px-2 bg-gray-300 ">
          <h1 className="text-center text-xl font-bold py-5">Recommended For You</h1>
